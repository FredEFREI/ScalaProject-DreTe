...
val test: GraphNonDirected[Int] = GraphNonDirected[Int](List(1, 2, 3), List((1, 2),(3, 2)))
...
import zio.json._
implicit val encoder: JsonEncoder[GraphNonDirected[Int]] = DeriveJsonEncoder.gen[GraphNonDirected[Int]]
