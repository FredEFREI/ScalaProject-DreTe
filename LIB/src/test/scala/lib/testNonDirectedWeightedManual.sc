...
val test: GraphNonDirectedWeighted[Int] = GraphNonDirectedWeighted[Int](List(1, 2, 3), List(((1, 2), 1),((3, 2), 3)))
...
import zio.json._
implicit val encoder: JsonEncoder[GraphNonDirectedWeighted[Int]] = DeriveJsonEncoder.gen[GraphNonDirectedWeighted[Int]]
